...
exports.init_ = (req, res) => {
  ...
  if(msg.flag == -1){
	...
	requestify.post(urlPostPais, req.body)
      ...
      requestify.post(urlGetDepartamentos, req.body)
        .then(function(response) {
  ...
  else if(msg.flag == 1)
  {
    /*var message = [				
      ...
      requestify.post(urlGetMunicipios, req.body)
        .then(function(response) {
          console.log("[response x0].. "+JSON.stringify(response));
          var aux = JSON.parse(response.body);
          console.log("[response x0] aux .. "+JSON.stringify(aux));
  ...
  else if(msg.flag == 2)
  {
	...
	requestify.post(urlPostCrearPersona, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 3)
  {
	...
	requestify.post(urlPostObtenerPersona, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 4)
  {
	...
	requestify.post(urlPostCrearMatrimonio, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 5)
  {
	...
	requestify.post(urlPostObtenerMatrimonio, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 6)
  {
	...
	requestify.post(urlPostCrearDivorcio, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 7)
  {
	...
	requestify.post(urlPostObtenerDivorcio, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 8)
  {
	...
	requestify.post(urlPostCreateDefuncion, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 9)
  {
	...
	requestify.post(urlPostObtenerDefuncion, req.body)
      .then(function(response) {
