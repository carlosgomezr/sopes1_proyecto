...
exports.init_ = (req, res) => {
  ...
  if(msg.flag == 0){
    ...
    requestify.post(urlConsultarDepartamentos, req.body)
  ...
  else if(msg.flag == 1)
  {
    ...
    requestify.post(urlConsultarMunicipios, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 2)
  {
	...
	requestify.post(urlCrearNacimiento, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 3)
  {
	...
	requestify.post(urlConsultarNacimiento, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 4)
  {
	...
	requestify.post(urlCrearMatrimonio, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 5)
  {
	...
	requestify.post(urlConsultarMatrimonio, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 6)
  {
	...
	requestify.post(urlCrearDivorcio, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 7)
  {
	...
	requestify.post(urlConsultarDivorcio, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 8)
  {
	...
	requestify.post(urlCrearDefuncion, req.body)
      .then(function(response) {
  ...
  else if(msg.flag == 9)
  {
	...
	requestify.post(urlConsultarDefuncion, req.body)
      .then(function(response) {
